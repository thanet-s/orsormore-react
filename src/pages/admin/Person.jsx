...
export default function Person() {
    ...
    return (
        <Switch>
            <Route exact path={`/admin/search/${houseId}/${id}`}>
                                                ...
                                                <div className="field">
                                                    <div className="control">
                                                        <p className='is-size-4'>
                                                            <Link to={`/admin/search/${houseId}/${id}/weight`}>
                                                                น้ำหนักส่วนสูง
                                                            </Link>
                                                        </p>
                                                    </div>
                                        ...
                                        <div className="field is-horizontal">
                                            ...
                                            <div className="field-body">
                                                <div className="field">
                                                    <div className="control">
                                                        <p className='is-size-4'>
                                                            <Link to={`/admin/search/${houseId}/${id}/blood`}>
                                                                เจาะเลือด
                                                            </Link>
                                                        </p>
                                                    </div>
                                        ...
                                        <div className="field is-horizontal">
                                            ...
                                            <div className="field-body">
                                                <div className="field">
                                                    <div className="control">
                                                        <p className='is-size-4'>
                                                            <Link to={`/admin/search/${houseId}/${id}/vital`}>
                                                                สัญญาณชีพ
                                                            </Link>
                                                        </p>
                                                    </div>
            ...
            <Route path={`/admin/search/:houseId/:id/weight`} component={Weight} />
            <Route path={`/admin/search/:houseId/:id/blood`} component={Blood} />
            <Route path={`/admin/search/:houseId/:id/vital`} component={Vital} />
        </Switch>
